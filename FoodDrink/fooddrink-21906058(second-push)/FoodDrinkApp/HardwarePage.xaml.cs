...
public partial class HardwarePage : ContentPage
{
    ...
    private async void OnGetLocationClicked(object? sender, EventArgs e)
    {
        ...
        {
            SetStatus("Location services are not supported on this device or emulator.");
        }
        catch (Exception ex)
        {
    ...
    private async void OnReadHelpClicked(object? sender, EventArgs e)
    {
        try
        {
            const string helpText = "FoodieSpot records foods and drinks, shows nutrition details, and uses camera, location, speech, and haptic feedback to make meal tracking more practical.";
        ...
        catch (Exception ex)
        {
            ...
            await DisplayAlert("TTS Error", $"Error: {ex.Message}\n\nMake sure TTS is enabled on your device settings.", "OK");
        }
    }
