...
public partial class FoodDetailPage : ContentPage
{
    ...
    private async Task LoadItemAsync(string id)
    {
        ...
        {
            currentItem = await _databaseService.GetByIdAsync(itemId);
            BindingContext = currentItem;
            RenderItem();
        }
        else
        {
            NameLabel.Text = "Invalid record identifier";
            DescriptionLabel.Text = "The provided ID could not be recognized.";
        }
    }
